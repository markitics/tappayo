...
### November 2025: @State vs @Binding - Persisting Draft Data Across Sheet Dismissals
...
@Binding var amountInCents: Int            // ← References parent's state ✓
@State private var itemName: String = ""  // ← Local to this view, resets on .onAppear ✗
